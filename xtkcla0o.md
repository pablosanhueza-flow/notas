...
- La reunion donde se discutio este tema esta en la nota [Traspaso ORD716 Medición aguas halladas STMG](nosmgxtc_mlp.md)
...
1.  Variables meteorológicas e hidrológicas históricas:
    - Registros de turbidez en bocatomas o puntos de control,
    - Caudales observados en los sectores de interés,
    - Registros o estimaciones de línea de nieve (isoterma 0) a nivel diario,
    - Gradiente de temperatura calibrado para la zona
2.  Modelación y pronósticos operacionales:
