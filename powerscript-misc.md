...
| gc .\lista_puntos.txt      Hace que existan History para los comandos | % {mkdir $_}                                                    |
...
- Guardar una variable con su descripcion [New-Variable -Name "mi_code" -Value (pwd).Path -Description "Ruta del directorio actual"]
