# Impacto de la calidad del liderazgo en espacios de trabajo sanos y seguros.

#learn #achs

- Que es la dimension calidad de liderazgo
  - es la forma qen que se expresa el mando de una jefatura sobre nosotros.
    - planificar el trabajo
    - resolver conflictos
    - colaborar para completar la tarea (escuchar y ayudar)
- La calidad del liderazgo facilita atender de manera efectiva los conflictos que suscitan en el trabajo.
- Resultados de la encuesta nacional de autoriodad (2022) para que una jefatura sea obedecida.
  ...
  - el mantenimiento de soportes de la autoridad en el trabajao se vincula con 2 aspectos.
    ...
    - Autoridades verticales, basada en el control y la amenaza.
    - las mujeres muestran mayor preocupacion.
      - existen estereotipos de genero en el ejercicio de la autoridad.
- Medidas para detectar problemas en el trabajo.
  - Cultura organizacional para prevencison de manera positiva.
  - Comunicacion abierta.
    - Mantener una conversacion diaria y sencilla.
    - Informar sobre decisiones importantes.
    - Informar a la alta direccion de las opiniones de quienes trabajan.
...
- Aprendizajes:
  ...
  - Se debe intervenir pronto para tener buen ambiente y evitar el estres.
  - El apoyo social (niveles gerenciales, linea supervisora y equipo de trabajo) ayuda a hacer frente a presiones y al estrés en el trabajo.
  - Una politica abierta y no discriminadora constituye una buena base para la prevencion del estres en el lugar de trabajo.
  - Las organizaciones deben INTERVENIR en la dimension en la calidad de liderazgo para prevenir problemas como la insatisfaccion laboral, el estre y la desmotivacion.
  - La jefatura debe escuchar y planificar.
